  ...
  return (
    <div className="p-6 flex flex-col bg-theme-bg border-2 border-theme-accent shadow-theme-sm m-4">
      <div className="flex flex-col gap-4">
        <h2 className="text-[28px] leading-[1.1] font-extrabold font-theme text-theme-text">Create Vault</h2>
        <p className="text-sm text-theme-text-secondary font-theme">Set up your master password to secure your credentials</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="confirm-password" className="text-xs text-theme-text-secondary font-theme uppercase tracking-wider">Confirm Password</label>
            <div className="relative flex items-center">
              <input
                id="confirm-password"
